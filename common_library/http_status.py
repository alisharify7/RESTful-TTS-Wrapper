...
def is_informational(code):
    """check http status code is_informational"""
    return 100 <= code <= 199


def is_success(code):
    """check http status code is_success"""
    return 200 <= code <= 299


def is_redirect(code):
    """check http status code is_redirect"""
    return 300 <= code <= 399


def is_client_error(code):
    """check http status code is_error"""
    return 400 <= code <= 499


def is_server_error(code):
    """check http status code is_server_error"""
    return 500 <= code <= 599
